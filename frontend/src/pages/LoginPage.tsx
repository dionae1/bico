...
import { login, refreshToken, googleURI } from "../services/auth";
        ...
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4">
            <div className="shadow-xl p-8 sm:p-10 rounded-lg bg-white w-full max-w-md border border-slate-200">
                ...
                <div className="flex flex-col items-center justify-center mt-2">
                    ...
                    <p className="text-slate-600 mt-3 text-center">Sign in to continue to BiCO</p>
                    {errorMessage && (
                ...
                <form className="flex flex-col w-full space-y-4" onSubmit={handleLogin}>
                    ...
                    <div>
                        <FormInput id="password" label="Password" placeholder="Enter your password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} />
                        {(password && invalidPassword) && <p className="text-red-500 text-xs mt-1.5">Password must be at least 4 characters.</p>}
                    </div>
                    <FormButton title="Sign In" onClick={handleLogin} />
                </form>
